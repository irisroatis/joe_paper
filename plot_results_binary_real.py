        ...
        for pretty_name in methods_list:
            ...
            if pretty_name in reverse_map:
                ...
                if (
                    ...
                    explicit_model_name = model_name_mapping.get(
                        original_model_name,
                        original_model_name
                    )
...
plt.savefig(
    '/Users/roatisiris/Desktop/results_final/new_add_exp/binary_real_results.pdf',
    bbox_inches='tight'
)
...
# Correct plotting order using names
dataset_order = [
    dataset_name_mapping[d]
    for d in dataset_whichones
]
...
plt.savefig(
    '/Users/roatisiris/Desktop/results_final/new_add_exp/binary_real_details.pdf',
    bbox_inches='tight'
)
